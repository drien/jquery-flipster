...
this,h=this.find("ul"),e=this.find("li"),g=0,m=0,c=0,s,q=!1,t={sideSpacing:0.57};d(window).load(function(){var b="\v"=="v",f=document.createElement("b");f.innerHTML="\x3c!--[if IE 9]><i></i><![endif]--\x3e";f=1==f.getElementsByTagName("i").length;if(b||f)q=!0,r.addClass("compatibility");g=!e.length%2?e.length/2+1:Math.floor(e.length/2);h.css("left","0px");r.show();n();p();d(window).resize(function(){n();p()});d(window).on("keydown.flipster",function(a){c++;if(0===c%7||1===c){var b=a.which;37==b&&
0<g?(a.preventDefault(),l("left")):39==b&&g<e.length-1&&(a.preventDefault(),l("right"))}});d(window).on("keyup.flipster",function(a){c=0});h.on("mousewheel.flipster",function(a){s=window.setTimeout(u,500);c++;if(0===c%4||1===c)window.clearTimeout(s),a.originalEvent.wheelDeltaX>e[0].clientWidth/1.75?l("left"):a.originalEvent.wheelDeltaX<-1*e[0].clientWidth/1.75&&l("right")});h.on("touchstart.flipster",function(a){m=a.originalEvent.targetTouches[0].screenX});h.on("touchmove.flipster",function(a){a.preventDefault();
a=a.originalEvent.targetTouches[0].screenX;var b=a-m;b>e[0].clientWidth/1.75?(l("left"),m=a):b<-1*(e[0].clientWidth/1.75)&&(l("right"),m=a)});h.on("touchend.flipster",function(a){m=0});h.on("click.flipster",".flipster-left, .flipster-right",function(a){a.preventDefault();l(e.index(this))})});return this}})(jQuery);
